    ...
    <body>
        <div class="container">
            <div class="row bg-cuatoi">
                <div class="col-md-12">
                    <h2 class="title ml-cuatoi my-5">Manage Category</h2>
                </div>
            </div>

            <div class="row bg-cuatoi">
                <button type="button" class="btn btn-primary width-fit ml-cuatoi">Add Category</button>
            </div>
                    ...
                    <table class="table ml-cuatoi width-table my-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Pizza</td>
                                <td>
                                    <img src="images/pizza.jpg" alt="" class="img-food width-img">
                                </td>
                                <td>Yes</td>
                                <td>Yes</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Burger</td>
                                <td>
                                    <img src="images/burger.jpg" alt="" class="img-food width-img">
                                </td>
                                <td>Yes</td>
                                <td>Yes</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Momo</td>
                                <td>
                                    <img src="images/momo.jpg" alt="" class="img-food width-img">
                                </td>
                                <td>Yes</td>
                                <td>Yes</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="images/safe_image.jpg" alt="" class="img-food width-img">
                                </td>
                                <td>Yes</td>
                                <td>Yes</td>
                                <td>
